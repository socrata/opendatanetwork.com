        ...
        datasets: [
            {
                ...
                name: 'Crime',
                description: `
                    Crime statistics are sourced from the
                    <a href="https://www.fbi.gov/about-us/cjis/ucr/ucr">
                    FBI Uniform Crime Reporting Program</a> and aggregated
                    across year and crime type. The FBI does not gather statistics for
                    all jurisdictions, so some localities may be missing. Normalization
                    is based on the population values published with the UCR data itself,
                    so rather than on US Census data, as the jurisdiction of the data may
                    vary. Crime rates are normalized on a per 100K basis;
                    specifically, the crime count is divided by the population count,
                    the result is then multiplied by 100K and rounded to the
                    nearest integer value.  For detailed crime timelines and incidents see: `,
                mapDescription: `
                    Note: The FBI Uniform Crime Reporting Program does not track all cities.
