    ...
    _createClass(SearchPageController, [{
        ...
        value: function drawPopulationMap() {
            ...
            controller.getPlaces().then(function (placesResponse) {
                ...
                var regionPlaces = _this11.getPlacesForRegion(placesResponse);
                ...
                // Init map
                //
                var radiusScale = _this11.getRadiusScaleLog(populations);
                var colorScale = _this11.getColorScale(populations);
                ...
                L.tileLayer('https://a.tiles.mapbox.com/v3/socrata-apps.ibp0l899/{z}/{x}/{y}.png').addTo(map);
                map.setView(center, _this11.MAP_INITIAL_ZOOM);

                // Populate map
                //
                _this11.drawCirclesForPlaces(map, populatedPlaces, radiusScale, colorScale);
                _this11.drawMarkersForPlaces(map, regionPlaces);
            }).catch(function (error) {
                return console.error(error);
            });
        }
        ...
        value: function drawChildPlacesInRegion(region, label) {
            ...
            controller.getChildRegions(region.id).then(function (response) {
                ...
                _this12.drawPlacesInRegionHeader('#places-in-region-header-0', label);
        ...
        value: function drawCitiesAndCountiesInState(region) {
            ...
            return Promise.all([citiesPromise, countiesPromise]).then(function (values) {
                ...
                if (values[0].length > 0) {
                    ...
                    _this13.drawPlacesInRegionHeader('#places-in-region-header-0', 'Places in {0}'.format(region.name));
                    _this13.drawPlacesInRegionList('#places-in-region-list-0', values[0]);
                }

                if (values[1].length > 0) {

                    _this13.drawPlacesInRegionHeader('#places-in-region-header-1', 'Counties in {0}'.format(region.name));
                    _this13.drawPlacesInRegionList('#places-in-region-list-1', values[1]);
                }
            }).catch(function (error) {
                return console.error(error);
            });
        ...
        value: function drawOtherCitiesInState(region) {
            ...
            controller.getParentState(region).then(function (response) {
                ...
                controller.getCitiesInState(state.parent_id).then(function (response) {
                    ...
                    _this14.drawPlacesInRegionHeader('#places-in-region-header-0', 'Places in {0}'.format(state.parent_name));
        ...
        value: function drawOtherCountiesInState(region) {
            ...
            controller.getParentState(region).then(function (response) {
                ...
                controller.getCountiesInState(state.parent_id).then(function (response) {
                    ...
                    _this15.drawPlacesInRegionHeader('#places-in-region-header-0', 'Counties in {0}'.format(state.parent_name));
        ...
        value: function drawOtherMetrosInState(region) {
            ...
            controller.getParentState(region).then(function (response) {
                ...
                controller.getMetrosInState(state.parent_id).then(function (response) {
                    ...
                    _this16.drawPlacesInRegionHeader('#places-in-region-header-0', 'Metropolitan Areas in {0}'.format(state.parent_name));
                    _this16.drawPlacesInRegionList('#places-in-region-list-0', response);
                }).catch(function (error) {
                    return console.error(error);
                });
            });
        ...
        value: function drawSimilarRegions(onClickRegion) {
            ...
            controller.getSimilarRegions(region.id).then(function (data) {
                return _this17.drawSimilarRegionsList(data, onClickRegion);
            }).catch(function (error) {
                return console.error(error);
            });
        }
        ...
        value: function getColorScale(values) {
            ...
            var domain = (function () {
                ...
                var step = 1.0 / _this18.MAP_COLOR_SCALE.length;

                function quantile(value, index, list) {
                    return d3.quantile(values, (index + 1) * step);
                }

                return _.map(_this18.MAP_COLOR_SCALE.slice(1), quantile);
            })();
        ...
        value: function getPlacesForRegion(data) {
            ...
            data.forEach(function (place) {
                ...
                _this19.params.regions.forEach(function (region) {
...
//# sourceMappingURL=data:application/json;base64,
