...
query = client.query(
    "CREATE TABLE documents (portal_title varchar(255), portal_url varchar(255), housing smallint, restaurant_inspections smallint, transit smallint, health smallint, crime smallint, permits smallint);" +
